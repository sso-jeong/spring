...
<div class="box">
        <form name="frm" id="frm" action="${pageContext.request.contextPath}/member/register" method="post">
            * 아이디 : <input type="text" maxlength="15" name="userid" id="userid" required autofocus />
            ...
            * 사용자 이름 : <input type="text" maxlength="5" name="username" required id="username" /><br />
                         이메일 : <input type="text" maxlength="50" name="email" id="email" /><br />
