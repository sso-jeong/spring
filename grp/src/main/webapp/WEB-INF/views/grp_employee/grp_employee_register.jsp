					...
					<div class="page-main-wrap">
						...
						<div class="title">
							<h3 class="tomato font18 noto m-t20">
								<i class="fas fa-feather-alt"></i> 사원조직/연락처 > 2. 사원등록
							</h3>
						</div>
						<div class="page-member-bottom">
							<div class="page-content">
								<form id="frm" method="post" action="${pageContext.request.contextPath}/employee/grp_admin_register" enctype="multipart/form-data">
									...
									<input type="hidden" name="empPwd" value="${empOne.empPwd}" />
									<div class="member-info flex flex-justify">
										<div class="member-left">
											<div class="photo-area">
												<img src="${pageContext.request.contextPath}/images/no.jpg" alt="" id="empPhotoImg" />
											</div>
										...
										<div class="member-right">
											<table>
												<tr>
													...
													<td class="td-13 p-lr3">
														<input type="text" name="empNum" id="empNum" class="input-135" value="${empOne.empNum}" /> 
													</td>
												</tr>
												<tr>
													<td class="td-7 center under bg-gray weight700">사원명/성별</td>
													<td class="td-13 p-lr3">
													<input type="text" name="empName" id="empName" class="input-75" readonly value="${empOne.empName}" />
													...
													<td class="td-13 p-lr3">
													<input type="text" name="empBirth" id="empBirth" class="input-75" maxlength="10" autofocus /> 
														<select name=""
														class="sel-55" id="">
													...
													<td class="td-13 p-lr3"><select name="" class="sel-55"
														id="">
															<option value="">010</option>
															<option value="">011</option>
													</select> <input type="text" name="empCP" id="empCP" class="input-75" maxlength="14"
														autofocus /></td>
													...
													</select> <input type="text" name="empTel" id="empTel" class="input-75" maxlength="14" 
														autofocus /></td>
													...
													<td class="td-13 p-lr3"><select name="" class="sel-55"
														id="">
															<option value="">02</option>
															<option value="">051</option>
													</select> <input type="text" name="empIn" id="empIn" class="input-75" maxlength="14"
														autofocus /></td>
												</tr>
												<tr>
													<td class="td-7 center under bg-gray weight700">채용형태</td>
													<td class="td-13 p-lr3"><select name="empRecruit"
														class="sel-135" id="empRecruit">
													...
													<td class="td-13 p-lr3"><input type="text" name="empHope"
														id="empHope" class="input-135" maxlength="30"/></td>
													<td class="td-7 center under bg-gray weight700">키/몸무게</td>
													<td class="td-13 p-lr3">
													<input type="text" name="empHeight"	id="empHeight" class="input-65" maxlength="3" placeholder="cm" />
													<input type="text" name="empWeight" id="empWeight" class="input-65" maxlength="3" placeholder="kg" /></td>
													
													<td class="td-7 center under bg-gray weight700">병역구분</td>
													<td class="td-13 p-lr3"><select name="empService"
														class="sel-135" id="empService">
												...
												<tr>
													...
													<td class="td-13 p-lr3"><input type="text" name="empHobby"
														id="empHobby" class="input-135" maxlength="20" /></td>
													<td class="td-7 center under bg-gray weight700">특기</td>
													<td class="td-13 p-lr3"><input type="text" name="empSpeciality"
														id="empSpeciality" class="input-135" maxlength="20" /></td>
													<td class="td-7 center under bg-gray weight700">장애여부</td>
													<td class="td-13 p-lr3"><select name="empDisability"
														class="sel-135" id="empDisability">
												...
												<tr>
													...
													<td class="td-13 p-lr3"><input type="text" name="empLicense1"
														id="empLicense1" class="input-135" maxlength="20"/></td>
													<td class="td-7 center under bg-gray weight700">보유자격 2</td>
													<td class="td-13 p-lr3"><input type="text" name="empLicense2"
														id="empLicense2" class="input-135" maxlength="20"/></td>
													<td class="td-7 center under bg-gray weight700">보유자격 3</td>
													<td class="td-13 p-lr3"><input type="text" name="empLicense3"
														id="empLicense3" class="input-135" maxlength="20"/></td>
													<td class="td-7 center under bg-gray weight700">보유자격 4</td>
													<td class="td-13 p-lr3"><input type="text" name="empLicense4"
														id="empLicense4" class="input-135" maxlength="20"/></td>
													<td class="td-7 center under bg-gray weight700">보유자격 5</td>
													<td class="td-13 p-lr3"><input type="text" name="empLicense5"
														id="empLicense5" class="input-135" maxlength="20"/></td>
												</tr>
												<tr>
													<td class="td-7 center under bg-gray weight700">어학사항 1</td>
													<td class="td-13 p-lr3"><input type="text" name="empLang1"
														id="empLang1" class="input-75" maxlength="20"/> <select name="" class="sel-55"
														id="">
													...
													<td class="td-13 p-lr3"><input type="text" name="empLang2"
														id="empLang2" class="input-75" maxlength="20" /> <select name="" class="sel-55"
														id="">
															<option value="">상</option>
															<option value="">중</option>
															<option value="">하</option>
													...
													<td class="td-13 p-lr3"><input type="text" name="empLang3"
														id="empLang3" class="input-75" maxlength="20"/> <select name="" class="sel-55"
														id="">
															<option value="">상</option>
															<option value="">중</option>
															<option value="">하</option>
													...
													<td class="td-13 p-lr3"><input type="text" name="empLang4"
														id="empLang4" class="input-75" maxlength="20"/> <select name="" class="sel-55"
														id="">
															<option value="">상</option>
															<option value="">중</option>
															<option value="">하</option>
													...
													<td class="td-13 p-lr3"><input type="text" name="empLang5"
														id="empLang5" class="input-75" maxlength="20"/> <select name="" class="sel-55"
														id="">
															<option value="">상</option>
															<option value="">중</option>
															<option value="">하</option>
									...
									<div class="comment">
										...
										<div class="content">
											<textarea id="editor" name="empComment"
												style="border: 1px solid #ccc; padding: 10px; border-radius: 2px;"
												class="noto"></textarea>
											<script>
